...
class Manage(Connection):
    ...
    def __init__(self, database: str) -> None:
        ...
        self.execute(
            'CREATE TABLE IF NOT EXISTS clients (id INT, username CHAR(255), password CHAR(255), session CHAR(255));')
    ...
    def create(self, username: str, password: str) -> dict[str, str] | None:
        ...
        if not self.execute(
            f'SELECT * FROM clients WHERE username=\'{username}\'').fetchone() is None:
            return None
